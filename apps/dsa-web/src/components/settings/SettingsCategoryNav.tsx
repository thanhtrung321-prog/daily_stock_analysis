...
export const SettingsCategoryNav: React.FC<SettingsCategoryNavProps> = ({
  ...
  return (
    <div className="h-full rounded-[1.5rem] border settings-border bg-card/94 p-4 shadow-soft-card-strong backdrop-blur-sm">
      <div className="mb-4">
        <p className="settings-accent-text text-xs font-semibold uppercase tracking-[0.3em]">Nhóm cấu hình</p>
        <p className="mt-1 text-[11px] leading-relaxed text-muted-text">Sắp xếp cấu hình hệ thống theo từng module.</p>
      </div>
