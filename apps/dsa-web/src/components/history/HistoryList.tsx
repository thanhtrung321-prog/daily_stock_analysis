      ...
      >
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <input
                  ...
                  disabled={isDeleting}
                  aria-label="Chọn toàn bộ lịch sử đã tải"
                ...
                />
                <span className="text-[11px] text-muted-text select-none">Chọn trang này</span>
              </label>
              <Button
        ...
        {isLoading ? (
          ...
          <DashboardStateBlock
            ...
            description="Sau phân tích đầu tiên, kết quả gần đây sẽ xuất hiện ở đây."
            icon={(
          ...
          <div className="space-y-2">
            ...
            {!hasMore && items.length > 0 && (
              <div className="text-center py-5">
                ...
                <span className="text-[10px] text-secondary-text uppercase tracking-[0.2em]">Đã tới cuối</span>
              </div>
            )}
          </div>
        )}
